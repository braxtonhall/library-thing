...
type DispatchEventParameters = BackgroundEvent;
type DispatchEventResponse = void;
...
const dispatchEvent = (event: BackgroundEvent): Promise<void> => {
...
export type {DispatchEventParameters, DispatchEventResponse};
